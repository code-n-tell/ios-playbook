...
### Additional context
Secure Storage is a feature that protects application secrets stored on the device by encrypting them at rest when the app uses iOS-backed key management correctly.
### Demonstration
...
1. Configure the app to create or load an iOS-managed encryption key to protect stored secrets
